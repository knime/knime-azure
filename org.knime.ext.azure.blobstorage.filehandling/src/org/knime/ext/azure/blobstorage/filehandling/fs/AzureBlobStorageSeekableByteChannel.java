 ...
 *
 * History
 *   2020-07-19 (Alexander Bondaletov): created
 */
...
/**
 * Azure Blob Storage implementation of the {@link TempFileSeekableByteChannel}.
 *
...
public class AzureBlobStorageSeekableByteChannel extends TempFileSeekableByteChannel<AzureBlobStoragePath> {
     ...
     * @throws IOException
     */
    protected AzureBlobStorageSeekableByteChannel(final AzureBlobStoragePath file,
