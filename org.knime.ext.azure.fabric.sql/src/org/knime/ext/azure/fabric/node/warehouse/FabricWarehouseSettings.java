...
public class FabricWarehouseSettings implements DefaultNodeSettings {
    ...
    @Widget(title = "Microsoft Fabric Warehouse", //
            description = "Select the Microsoft Fabric Warehouse to use.")
    ...
    void validate(final PortObjectSpec[] inSpecs) throws InvalidSettingsException {
        ...
        if (StringUtils.isBlank(m_warehouseId)) {
            throw new InvalidSettingsException("Please specify a Microsoft Fabric Warehouse");
        }
    }
    ...
    private static final class WarehouseChoiceProvider implements StringChoicesProvider {
        ...
        public List<StringChoice> computeState(final DefaultNodeSettingsContext context) {
            try {
                ...
                LOGGER.info("Unable to fetch Fabric Warehouses list.", e);
