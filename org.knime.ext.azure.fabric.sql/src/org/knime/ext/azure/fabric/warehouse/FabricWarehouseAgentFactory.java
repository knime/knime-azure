...
/**
 * {@linkplain DBAgentFactory Agent factory} for the Fabric Warehouse.
 *
...
public class FabricWarehouseAgentFactory extends MSSQLAgentFactory {
    ...
    // AttributeCollection.builder(DefaultDBMetadataReader.ATTRIBUTES);
    // builder.add(Accessibility.EDITABLE,
    // DefaultDBMetadataReader.ATTRIBUTE_CAPABILITY_MULTI_DBS, false);
    ...
    public FabricWarehouseAgentFactory() {
        ...
        // parameters -> new
        // MSSQLServerDBMetadataReader(parameters.getSessionReference()));
