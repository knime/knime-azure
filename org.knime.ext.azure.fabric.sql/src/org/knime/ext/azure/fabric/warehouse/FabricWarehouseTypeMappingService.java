...
public final class FabricWarehouseTypeMappingService
    ...
    private FabricWarehouseTypeMappingService() {
        ...
        // The "datetime" datatype doesn't support microseconds.
        // The "datetime2" datatype should be used instead but we can't use them
        //   because the JTDS driver doestn't support the "datetime2" type!
        // https://sourceforge.net/p/jtds/feature-requests/73/
        addColumnType(JDBCType.TIMESTAMP, "datetime");
        addColumnType(JDBCType.TIMESTAMP_WITH_TIMEZONE, "datetimeoffset");
