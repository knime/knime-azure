...
public class FabricWarehouseConnectorNodeFactory extends ConfigurableNodeFactory<FabricWarehouseConnectorNodeModel>
    ...
    private static final String FULL_DESCRIPTION =
            "The Microsoft Fabric Warehouse Connector node allows to connect to a Microsoft Fabric Warehouse.";

    static final WebUINodeConfiguration CONFIG = WebUINodeConfiguration.builder()//
            .name("Microsoft Fabric Warehouse Connector")//
            .icon("./icon.png")//
            .shortDescription("Microsoft Fabric Warehouse Connector node.")//
