...
/**
 * Utility class for handling credentials related to Microsoft Fabric Warehouse.
 *
...
final class FabricWarehouseCredentialUtil {
    ...
    private static final String DATABASE_SCOPE = "https://database.windows.net/user_impersonation";
            ...
            try {
                ...
                if (!isCompatible) {
                    throw new InvalidSettingsException(
                            "Provided credential cannot be used with Microsoft Fabric Warehouse");
                }
    ...
    public static AccessTokenAccessor toAccessTokenAccessor(final CredentialRef credentialRef)
        ...
        if (credentialRef.hasAccessor(AccessTokenAccessor.class)) {
            ...
            throw new IllegalStateException(
                    "The provided credential is incompatible with Microsoft Fabric Warehouse");
        }
    }
}
