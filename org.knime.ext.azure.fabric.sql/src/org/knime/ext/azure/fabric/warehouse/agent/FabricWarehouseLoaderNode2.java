...
import org.knime.bigdata.database.loader.ColumnListsProvider;
import org.knime.bigdata.database.loader.DBtoParquetTypeUtil;
import org.knime.bigdata.database.loader.TempTableColumnListProvider;
...
public class FabricWarehouseLoaderNode2
    ...
    private static ColumnListsProvider buildAndValidateColumnLists(final DBSession session, final ExecutionMonitor exec,
        ...
        FabricWarehouseLoaderNode2.validateColumns(tableSpec, knimeToExternalTypeMapping, session,
