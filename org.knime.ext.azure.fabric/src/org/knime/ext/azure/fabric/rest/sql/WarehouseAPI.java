...
public interface WarehouseAPI {
    ...
    /**
     * Lists the first chunk of warehouses for the given workspace.
     *
     * @param workspaceId
     *            the unique Fabric workspace id to list all Warehouses for
    ...
    Warehouses listWarehouses(@PathParam("workspaceId") String workspaceId) throws IOException;

    /**
     * Lists the next chunk (based on continuation token) of warehouses for the
     * given workspace.
     *
     * @param workspaceId
     *            the unique Fabric workspace id to list all Warehouses for
