...
/**
 * Specification for the {@link FabricWorkspacePortObject}.
 *
...
public final class FabricWorkspacePortObjectSpec extends AbstractSimplePortObjectSpec {
    ...
    private FabricConnection m_fabricConnection;

    /**
     * Constructor for a port object spec that holds no {@link FabricConnection}.
     */
    public FabricWorkspacePortObjectSpec() {
        m_fabricConnection = null;
    }

    /**
     * @param fabricConnection
     *            The {@link FabricConnection} that will be contained by this port
     *            object spec
     */
    public FabricWorkspacePortObjectSpec(final FabricConnection fabricConnection) {
        m_fabricConnection = fabricConnection;
    }
    ...
    public FabricConnection getFabricConnection() {
        return m_fabricConnection;
    }

    @Override
    protected void save(final ModelContentWO model) {
        m_fabricConnection.save(model);
    }

    @Override
    protected void load(final ModelContentRO model) throws InvalidSettingsException {
        m_fabricConnection = new FabricConnection(model);
    }
    ...
    public boolean equals(final Object ospec) {
        ...
        return m_fabricConnection.equals(spec.m_fabricConnection);
    }

    @Override
    public int hashCode() {
        return m_fabricConnection != null ? m_fabricConnection.hashCode() : 0;
    }
