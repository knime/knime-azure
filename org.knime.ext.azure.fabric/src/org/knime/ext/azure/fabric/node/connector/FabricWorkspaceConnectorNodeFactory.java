...
public class FabricWorkspaceConnectorNodeFactory extends ConfigurableNodeFactory<FabricWorkspaceConnectorNodeModel>
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, FabricWorkspaceSettings.class);
    }
    ...
    @Override
    protected FabricWorkspaceConnectorNodeModel createNodeModel(final NodeCreationConfiguration creationConfig) {
        final PortsConfiguration portsConfig = creationConfig.getPortConfig().orElseThrow();
        return new FabricWorkspaceConnectorNodeModel(portsConfig);
    }
