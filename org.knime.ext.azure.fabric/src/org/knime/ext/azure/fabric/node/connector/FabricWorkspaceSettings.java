...
public class FabricWorkspaceSettings implements DefaultNodeSettings {
    ...
    @Widget(title = "Microsoft Fabric workspace", //
            description = "Full URL of the Microsoft Fabric workspace, e.g. https://&lt;workspace&gt;.cloud.databricks.com/ "//
    ...
    private void validateWorkspaceURL() throws InvalidSettingsException {
        if (StringUtils.isBlank(m_workspace)) {
            throw new InvalidSettingsException("Please specify a Microsoft Fabric workspace URL");
        }
    }
